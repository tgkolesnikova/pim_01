# Жизненный цикл разработки ИТ-систем. Декомпозиция.
...
1. В работе над проектами (здесь и далее) в качестве даты добавления понятия в глоссарий можно указывать, например, номер работы, выполняя который было добавлено данное понятие (Пример: PIM_01).
